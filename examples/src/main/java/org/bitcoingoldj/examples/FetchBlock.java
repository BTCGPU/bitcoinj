 ...
 * After bitcoind is up and running, use command: org.bitcoingoldj.examples.FetchBlock --localhost &lt;blockHash&gt; </p>
 * <p>Otherwise, use command: org.bitcoingoldj.examples.FetchBlock &lt;blockHash&gt;, this command will download blocks from a peer generated by DNS seeds.</p>
 */
public class FetchBlock {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (opts.has("help")) {
                System.out.println("usage: org.bitcoingoldj.examples.FetchBlock [--localhost] <blockHash>");
            ...
            System.err.println("usage: org.bitcoingoldj.examples.FetchBlock [--localhost] <blockHash>");
